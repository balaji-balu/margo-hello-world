...
// function as ApplicationDesc mutator.
type ApplicationDescFunc func(context.Context, *ent.ApplicationDescMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ApplicationDescFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ApplicationDescMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ApplicationDescMutation", m)
}
...
// Mutate calls f(ctx, m).
func (f DeploymentProfileFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DeploymentProfileMutation); ok {
		return f(ctx, mv)
	}
...
// The OrchestratorFunc type is an adapter to allow the use of ordinary
// function as Orchestrator mutator.
type OrchestratorFunc func(context.Context, *ent.OrchestratorMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OrchestratorFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OrchestratorMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OrchestratorMutation", m)
}
